 ...
 *
 */
public class ValueMainXLarge implements MainInterface{
	...
	public static void main(String[] args) {
		...
		ValueMainXLarge mainObj = new ValueMainXLarge();
	...
	public void executeAnalysis(Dataset ds) {
		long startTime;
		long finishTime;
		List<AbstractTransaction> valueList = convertToTransaction(ds, new ValueTransactionXLarge());
		startTime = System.currentTimeMillis();
		double sum =0;
