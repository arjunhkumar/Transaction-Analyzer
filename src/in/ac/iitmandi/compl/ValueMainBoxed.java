 ...
 *
 */
public class ValueMainBoxed implements MainInterface{
	...
	public static void main(String[] args) {
		...
		ValueMainBoxed mainObj = new ValueMainBoxed();
	...
	public void executeAnalysis(Dataset ds) {
		...
		long finishTime;
		startTime = System.currentTimeMillis();
		List<AbstractTransaction> valueList = convertToTransaction(ds, new ValueTransactionBox());
		double sum =0;
